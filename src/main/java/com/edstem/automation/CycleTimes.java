...
public class CycleTimes {
    ...
    @FindBy(xpath = "//div[text()='CYCLE TIMES']")
    private WebElement cycleTimesTab;

    @FindBy(xpath = "(//div/p[contains(text(), 'Duration of')])[1]")
    private WebElement firstCard;
    @FindBy(xpath = "(//div/p[contains(text(), 'Share of projects')])[1]")
    private WebElement secondCard;
    @FindBy(xpath = "(//div/p[contains(text(), 'Median acceleration /')])[1]")
    private WebElement thirdCard;
    @FindBy(xpath = "(//div/p[contains(text(), 'Median time spent')])[1]")
    private WebElement fourthCard;
    @FindBy(xpath = "//div[@class='stacked-bar-chart']")
    private WebElement allCardChart;
    ...
    @FindBy(xpath = "(//div/p[contains(text(), 'Speed Enablers')])[1]")
    private WebElement firstScienceCard;
    @FindBy(xpath = "(//div/p[contains(text(), 'ractability score')])[1]")
    private WebElement secondScienceCard;
    @FindBy(xpath = "(//div/p[contains(text(), 'C2LO rea')])[1]")
