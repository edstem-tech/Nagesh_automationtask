...
public class SummaryTab 
{
	...
	@FindBy (xpath="//div[text()='SUMMARY']") private WebElement summaryTab;
	
	@FindBy (xpath="(//span[text()='All'])[1]") private WebElement geneticValidation;
	@FindBy (xpath="(//span[@class='checkbox-icon']//*[local-name()='svg'])[2]") private WebElement checkboxOfGeneticValidation;
	
	@FindBy (xpath="(//span[text()='All'])[3]") private WebElement immunomodulation;
	@FindBy (xpath="(//span[@class='checkbox-icon']//*[local-name()='svg'])[7]") private WebElement checkboxOfImmunomodulation;
		
	@FindBy (xpath="(//span[text()='All'])[5]") private WebElement portfolioOwner;
	@FindBy (xpath="(//span[@class='checkbox-icon']//*[local-name()='svg'])[10]") private WebElement checkboxOfPortfolioOwner;
	
	@FindBy (xpath="(//span[text()='All'])[7]") private WebElement researchUnit;
	@FindBy (xpath="(//span[@class='checkbox-icon']//*[local-name()='svg'])[14]") private WebElement checkboxOfResearchUnit;
	
	@FindBy (xpath="(//span[text()='All'])[9]") private WebElement modality;
	@FindBy (xpath="(//span[@class='checkbox-icon']//*[local-name()='svg'])[23]") private WebElement checkboxOfModality;
	
	@FindBy (xpath="(//span[text()='All'])[11]") private WebElement lifecyclePhases;
	@FindBy (xpath="(//span[@class='checkbox-icon']//*[local-name()='svg'])[29]") private WebElement checkboxOfLifecyclePhases;
	
	@FindBy (xpath="(//span[text()='All'])[13]") private WebElement time;
	@FindBy (xpath="(//span[@class='checkbox-icon']//*[local-name()='svg'])[39]") private WebElement checkboxOfTime;
	
	@FindBy (xpath="(//span[text()='SHOW DETAILS'])[1]") private WebElement lifcycleInvocationDetails;
	@FindBy (xpath="//span[text()='Lifecycle Innovation']") private WebElement lifcycleInvocationTitle;
	
	@FindBy (xpath="(//span[text()='SHOW DETAILS'])[2]") private WebElement cycleTimeDetails;
	@FindBy (xpath="//span[text()='Cycle Times']") private WebElement cycleTimeTitle;
	
	@FindBy (xpath="(//span[text()='SHOW DETAILS'])[3]") private WebElement successRatesDetails;
	@FindBy (xpath="//span[text()='Success Rates']") private WebElement successRatesTitle;
