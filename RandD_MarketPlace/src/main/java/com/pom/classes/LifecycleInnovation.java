...
public class LifecycleInnovation 
{
	...
	@FindBy (xpath="//div[text()='LIFECYCLE INNOVATION']") private WebElement lifecycleInnovationTab;
	
	@FindBy (xpath="//div/p/b[text()='IEF Scope list']") private WebElement iefScopeListCard;
	@FindBy (xpath="//div/p/b[text()='IEF Shortlist']") private WebElement iefShortListCard;
	@FindBy (xpath="//div/p/b[text()='Proposed']") private WebElement proposedCard;
	@FindBy (xpath="//div/p/b[text()='Approved']") private WebElement approvedCard;
	@FindBy (xpath="//div/p/b[contains(text(), 'Clinical') ]") private WebElement clinicalProjectCard;
	
	@FindBy (xpath="//div[@class='comparision-table-of-lifecycle']") private WebElement comparativeChart;
