...
WebDriver driver;
	...
	@FindBy (xpath="//div[text()='SUCCESS RATES']") private WebElement successRatesTab;
	
	@FindBy (xpath="//div[@class='display-chart']") private WebElement businessOutlierChart;
	@FindBy (xpath="(//span[@class='arrow-icon']//*[local-name()='svg'])[8]") private WebElement dropDownListOfOutlier;
	@FindBy (xpath="(//span[text()='Phase I'])[2]") private WebElement dropDownPhaseI;
	...
	@FindBy (xpath="(//div/p[contains(text(), 'Biomarker')])[1]") private WebElement firstScienceCard;
	@FindBy (xpath="(//div/p[contains(text(), 'PoPs S')])[1]") private WebElement secondScienceCard;
	@FindBy (xpath="(//div/p[contains(text(), 'TIPS in')])[1]") private WebElement thirdScienceCard;
